...
(/** @lends <global> */function( $ ) {
	...
	function _fnAddColumn( oSettings, nTh )
	{
		...
		var oCol = $.extend( {}, DataTable.models.oColumn, oDefaults, {
			...
			"aDataSort": oDefaults.aDataSort ? oDefaults.aDataSort : '',//original[iCol],
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		//var input = '<input type="search" class="'+classes.sFilterInput+'"/>'; ORIGINAL
		var input = '<div class="input-group custom-search-form"><input type="search"  placeholder="Search..." class="form-control"/><span class="input-group-btn"><button class="btn btn-default" type="button"><i class="fa fa-search">Ok</i></button></span></div>';
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(Encontrou no Total de _MAX_ Registros)",
